 ...
 *
 * Android played the .m4v movies through the Java MediaPlayer and polled
 * isMoviePlaying(); here we decode with FFmpeg on a worker thread and overlay
 * the frames before each eglSwapBuffers call.
 *
